...
* Use the shortcode [instantagram_slider] to display the instagram feed within your content slider layout.
* Use the function `<?php do_shortcode('[instantagram_slider]'); ?>` to display within template or theme files slider layout.
